...
from apps.views import(
    ...
    apps_projects_delete_view,
    apps_Companies_list_view,
    apps_Companies_Create_view,
    apps_Companies_overview_view,
...
urlpatterns = [
    ...
    # path("projects/list", view=apps_projects_delete_view, name="projects.delete"),
    path("projects/delete-project/<int:pk>", view=apps_projects_delete_view, name="projects.delete"),
    # path("projects/overview/<int:pk>", view=apps_projects_overview_view, name="projects.overview"),
    ...
    path("crm/companies_create", view=apps_crm_add_companies_view, name="crm.companies"), 
    ...
    path("crm/delete-companies/<int:pk>", view=apps_crm_delete_companies_view, name="delete_companies"),
    ...
    #NFT Pages
    path("nft/marketpFce", view=apps_nft_marketplace_view, name="nft.marketplace"),
