    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contractors', models.ManyToManyField(blank=True, related_name='company_contractors', to=settings.AUTH_USER_MODEL)),
                ('marketers', models.ManyToManyField(blank=True, related_name='companies', to=settings.AUTH_USER_MODEL)),
                ...
                ('user_deleted', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='deleted_companies', to=settings.AUTH_USER_MODEL)),
                ('user_restored', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='restored_companies', to=settings.AUTH_USER_MODEL)),
                ('user_updated', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='updated_companies', to=settings.AUTH_USER_MODEL)),
                ('company_details', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='apps.company_details')),
            ],
        ),
        migrations.CreateModel(
            name='CrmContact',
