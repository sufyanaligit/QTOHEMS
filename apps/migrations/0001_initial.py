# Generated by Django 4.2.6 on 2023-11-02 17:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contractor_type', models.CharField(choices=[('Contractor', 'Contractor'), ('Sub_Contractor', 'Sub Contractor'), ('General Contractor', 'General Contractor'), ('completed', 'Completed')], default='Contractor', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Started', 'Started'), ('pending', 'Pending'), ('in_progress', 'In Progress'), ('completed', 'Completed'), ('Closed', 'Closed')], default='pending', max_length=20)),
                ...
                ('user_created', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='created_Project', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('solicitation_date', models.DateField()),
                ('liquidated_damages', models.DecimalField(decimal_places=2, max_digits=10)),
                ('pre_bid_meeting_date', models.DateField()),
                ('pre_bid_meeting_notes', models.TextField()),
                ('bid_bond', models.BooleanField(default=False)),
                ('performance_bond', models.BooleanField(default=False)),
                ('bid_date', models.DateField()),
                ('bid_amount', models.DecimalField(decimal_places=2, max_digits=10)),
                ('bid_location', models.CharField(max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mwsebs', models.BooleanField(default=False)),
                ('sdvobs', models.BooleanField(default=False)),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.project')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='company',
            name='user_created',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='created_companies', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='company',
            name='user_deleted',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bid_amount', models.DecimalField(decimal_places=2, max_digits=10)),
                ('bid_outcome', models.CharField(max_length=20)),
                ('company', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='apps.company')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.project')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('bidding_method', models.CharField(choices=[('Open', 'Open'), ('Closed', 'Closed'), ('Selective', 'Selective')], max_length=20)),
                ('bid_phase', models.CharField(choices=[('Pre-Bid', 'Pre-Bid'), ('Bidding', 'Bidding'), ('Post-Bid', 'Post-Bid')], max_length=20)),
                ('project_completion_time', models.IntegerField()),
